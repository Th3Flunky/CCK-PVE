#!/usr/bin/env bash
source <(curl -s https://raw.githubusercontent.com/Th3Flunky/CopyCatKing-PVE/refs/heads/main/build.func)
...
UPD=$(whiptail --backtitle "PVE H3lperz" --title "SUPPORT" --radiolist --cancel-button Exit-Script "Spacebar = Select \nplexupdate info >> https://github.com/mrworf/plexupdate" 10 59 2 \
  "1" "Update LXC" ON \
